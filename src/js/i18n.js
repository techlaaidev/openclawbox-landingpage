...
const translations = {
  vi: {
    ...
    "hero.title": "OpenClawBox ProMax",
    "hero.subtitle": "AI Agent cho doanh nghiệp — Thiết lập sẵn trên Mini PC cấu hình cao.<br>Tài chính, Marketing, Sales — Vận hành tự động 24/7.",
    "hero.price": "7.990.000₫",
    "hero.price.note": "Chưa bao gồm VAT • Miễn phí vận chuyển toàn quốc",
    ...
    "features.1.title": "Tài Chính Thông Minh",
    "features.1.desc": "Scan ảnh/hóa đơn tự động nhập liệu. Tổng hợp báo cáo thu chi. Tự động điền 3 file báo cáo thuế (đầu vào, đầu ra, chi phí).",
    "features.2.title": "Tổng Hợp Đa Nguồn",
    "features.2.desc": "Kết nối và nhận số liệu từ các phần mềm khác. Tự động tổng hợp, phân tích và tạo báo cáo thống nhất.",
    "features.3.title": "Quản Lý Lịch Trình",
    "features.3.desc": "Thêm, sửa, xóa lịch cá nhân. Nhắc lịch tự động qua Zalo/Email. Đồng bộ với Google Calendar.",
    "features.4.title": "Tin Tức Đa Kênh",
    "features.4.desc": "Cập nhật tin tức từ nhiều nguồn. AI lọc tin hay, liên quan. Tổng hợp và gửi digest hàng ngày.",
    "features.5.title": "Cơ Hội Hợp Tác",
    "features.5.desc": "Tự động check mail, thu thập leads. Phân loại đối tác tiềm năng, nhu cầu cụ thể. Tổng hợp cơ hội mỗi ngày.",
    "features.6.title": "Đánh Giá Đối Tác",
    "features.6.desc": "Research thông tin đối tác tự động. Phân tích uy tín, reviews. Báo cáo đánh giá rủi ro trước hợp tác.",
    "features.7.title": "Phân Tích Quảng Cáo",
    "features.7.desc": "Báo cáo dữ liệu quảng cáo hàng ngày. AI đưa ra insights và lời khuyên tối ưu chiến dịch, tăng ROI.",
    "features.8.title": "CRM Thông Minh",
    "features.8.desc": "Quản lý khách hàng, lịch sử trò chuyện, đơn hàng. Dashboard phân tích. Gợi ý kịch bản chốt đơn hiệu quả.",
    "features.9.title": "Google Workspace",
    "features.9.desc": "Tích hợp Sheet, Gmail, Drive, Calendar. Phân tích file, tạo báo cáo, gửi mail, phân loại mail tự động.",
    "features.10.title": "Phân Tích Đối Thủ",
    ...
    "specs.processor.value": "AMD Ryzen™ R1505G Dual Core",
    "specs.ram": "Bộ nhớ",
    "specs.ram.value": "8GB",
    "specs.storage": "Lưu trữ",
    "specs.storage.value": "128GB SSD",
    "specs.os": "Phần mềm",
    "specs.os.value": "Ubuntu + OpenClawBox AI Agent",
    ...
    "pricing.name": "OpenClawBox ProMax",
    "pricing.price": "7.990.000₫",
    "pricing.period": "Thanh toán một lần • Chưa bao gồm VAT • Miễn phí vận chuyển",
    "pricing.feature.1": "Mini PC Ryzen R1505G, 8GB RAM, 128GB SSD",
    ...
    "pricing.feature.5": "Bảo hành phần cứng 1 tháng",
    ...
    "cta.text": "Tham gia cùng hàng trăm doanh nghiệp đang vận hành với OpenClawBox AI Agent.<br>Thiết lập sẵn, sẵn sàng sử dụng — Chỉ 7.990.000₫ (chưa VAT)",
  ...
  en: {
    ...
    "hero.title": "OpenClawBox ProMax",
    "hero.subtitle": "AI Agent for Business — Pre-configured on High-Performance Mini PC.<br>Finance, Marketing, Sales — Running 24/7 Automatically.",
    "hero.price": "7,990,000₫",
    "hero.price.note": "Excluding VAT • Free shipping nationwide",
    ...
    "features.1.title": "Smart Finance",
    "features.1.desc": "Scan invoices/receipts for auto data entry. Generate income/expense reports. Auto-fill 3 tax report files.",
    "features.2.title": "Multi-Source Integration",
    "features.2.desc": "Connect and receive data from other software. Automatically consolidate, analyze, and create unified reports.",
    "features.3.title": "Schedule Management",
    "features.3.desc": "Add, edit, delete personal schedules. Auto reminders via Zalo/Email. Sync with Google Calendar.",
    "features.4.title": "Multi-Channel News",
    "features.4.desc": "Aggregate news from multiple sources. AI filters relevant content. Send daily digest summaries.",
    "features.5.title": "Partnership Opportunities",
    "features.5.desc": "Auto-check emails, collect leads. Classify potential partners and needs. Daily opportunity summaries.",
    "features.6.title": "Partner Evaluation",
    "features.6.desc": "Auto-research partner information. Analyze credibility and reviews. Risk assessment reports before cooperation.",
    "features.7.title": "Ads Analytics",
    "features.7.desc": "Daily advertising data reports. AI provides insights and optimization advice for campaigns, increase ROI.",
    "features.8.title": "Smart CRM",
    "features.8.desc": "Manage customers, chat history, orders. Analytics dashboard. Suggest effective closing scripts.",
    "features.9.title": "Google Workspace",
    "features.9.desc": "Integrate Sheet, Gmail, Drive, Calendar. Analyze files, create reports, send emails, auto-classify emails.",
    "features.10.title": "Competitor Analysis",
    ...
    "pricing.name": "OpenClawBox ProMax",
    "pricing.price": "7,990,000₫",
    "pricing.period": "One-time payment • Excluding VAT • Free shipping",
    "pricing.feature.1": "Mini PC Ryzen R1505G, 8GB RAM, 128GB SSD",
    ...
    "pricing.feature.5": "1-month hardware warranty",
    ...
    "cta.text": "Join hundreds of businesses operating with OpenClawBox AI Agent.<br>Pre-configured, ready to deploy — Only 7,990,000₫ (excl. VAT)",
    "cta.order": "Order Now",
