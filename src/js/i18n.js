...
const translations = {
  vi: {
    ...
    "specs.ram": "Bộ nhớ",
    "specs.ram.value": "4GB (nâng cấp 8GB)",
    "specs.storage": "Lưu trữ",
    "specs.storage.value": "64GB SSD",
    "specs.os": "Phần mềm",
    "specs.os.value": "OpenClawBox AI Agent",
    "specs.connectivity": "Kết nối",
    "specs.connectivity.value": "Ethernet, USB 3.0, USB 2.0",
    "specs.power": "Nguồn điện",
    "specs.power.value": "Tiết kiệm điện năng (kèm adapter)",
  ...
  en: {
    ...
    "specs.processor.value": "AMD Ryzen R1505G Dual Core",
    "specs.ram": "Memory",
    "specs.ram.value": "4GB (upgradable to 8GB)",
    ...
    "specs.connectivity.value": "Ethernet, USB 3.0, USB 2.0",
    "specs.power": "Power",
    "specs.power.value": "Energy efficient (adapter included)",
    "specs.size": "Size",
